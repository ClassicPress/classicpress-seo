...
class Date implements IPaper {
	...
	public function title() {
		return Paper::get_from_options( 'cpseo_date_archive_title' );
	}
	...
	public function description() {
		return Paper::get_from_options( 'cpseo_date_archive_description' );
	}
	...
	public function robots() {
		$robots = [];
		$robots = Paper::robots_combine( Helper::get_settings( 'titles.cpseo_date_archive_robots' ) );
		if ( Helper::get_settings( 'titles.cpseo_disable_date_archives' ) ) {
