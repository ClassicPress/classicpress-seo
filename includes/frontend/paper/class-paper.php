...
class Paper {
	...
	public function get_title() {
		...
		// Capitalize Titles.
		if ( Helper::get_settings( 'titles.cpseo_capitalize_titles' ) ) {
	...
	public function get_robots() {
		...
		if ( empty( $this->robots ) ) {
			$this->robots = self::robots_combine( Helper::get_settings( 'titles.cpseo_robots_global' ) );
		}
	...
	private function respect_settings_for_robots() {
		...
		if ( is_paged() && Helper::get_settings( 'titles.cpseo_noindex_archive_subpages' ) ) {
			$this->robots['index'] = 'noindex';
		}
	}
	...
	private function generate_canonical() {
		 ...
		 */
		$this->canonical['canonical'] = apply_filters( 'cpseo/frontend/canonical', $canonical );
	}
