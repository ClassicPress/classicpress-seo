...
class Taxonomy implements IPaper {
	...
	public function title() {
		...
		return Paper::get_from_options( "cpseo_tax_{$object->taxonomy}_title", $object );
	}
	...
	public function description() {
		...
		return Paper::get_from_options( "cpseo_tax_{$object->taxonomy}_description", $object );
	}
	...
	public function robots() {
		...
		if ( is_object( $object ) && empty( $robots ) && Helper::get_settings( "titles.cpseo_tax_{$object->taxonomy}_custom_robots" ) ) {
			$robots = Paper::robots_combine( Helper::get_settings( "titles.cpseo_tax_{$object->taxonomy}_robots" ), true );
		}
	...
	private function noindex_term( $object ) {
		...
		if ( is_object( $object ) && 0 === $object->count && Helper::get_settings( 'titles.cpseo_noindex_empty_taxonomies' ) ) {
