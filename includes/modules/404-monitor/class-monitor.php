...
class Monitor {
	...
	public function delete_log() {
		...
		DB::delete_log( $id );
		$this->success( esc_html__( 'Log successfully deleted.', 'cpseo' ) );
	}
	...
	public function capture_404() {
		...
		$uri = untrailingslashit( Helper::get_current_page_url( Helper::get_settings( 'general.cpseo_404_monitor_ignore_query_parameters' ) ) );
	...
	private function is_url_excluded( $uri ) {
		$excludes = Helper::get_settings( 'general.cpseo_404_monitor_exclude' );
