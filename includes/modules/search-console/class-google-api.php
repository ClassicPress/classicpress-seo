...
class Google_Api {
	...
	private function determine_success( $response, $formatted_response ) {
		...
		if ( isset( $formatted_response['error_description'] ) ) {
			$this->last_error = 'Bad Request' === $formatted_response['error_description'] ?
				esc_html__( 'Bad request. Please check the code.', 'cpseo' ) : $formatted_response['error_description'];
			return;
		}
	...
	private function get_config() {
		return [
			...
			'client_id'        => '527335811464-va8fu6jn7adhbtilk6ki31pevj4tg9ba.apps.googleusercontent.com',
			'client_secret'    => 'XOffLdWAZc3pZ1I9vEJ2qNxL',
