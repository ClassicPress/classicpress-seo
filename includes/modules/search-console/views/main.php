...
use Classic_SEO\Search_Console\Client;
use Classic_SEO\Helpers\Param;

$dir = dirname( __FILE__ ) . '/';
$tab = Param::get( 'view', 'overview' );
?>
<div class="wrap cpseo-wrap cpseo-search-console cpseo-search-console-<?php echo $tab; ?>">
	...
	if ( Client::get()->is_authenticated() ) {
		...
		// Search Console - Sitemaps Tab
			...
			echo '<p>' . esc_html__( 'Review sitemaps submitted to your Search Console account.', 'cpseo' ) . '</p>';
