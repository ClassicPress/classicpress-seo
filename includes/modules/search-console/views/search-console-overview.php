...
<br>
<div class="cpseo-notice notice notice-info inline">
	<p>
		<?php /* translators: admin screen link */ ?>
		<?php printf( wp_kses_post( __( 'The data sets are empty in your cache. You can wait for the next cronjob or <strong>Update Manually</strong>. Please navigate to <a href="%s">SEO > Settings > Search Console</a>.', 'cpseo' ) ), esc_url( Helper::get_admin_url( 'options-general#setting-panel-search-console' ) ) ); ?>
	</p>
</div>
	<?php
	return;
...
?>
<div class="cpseo-row search-console-analysis-overview">
	<?php
