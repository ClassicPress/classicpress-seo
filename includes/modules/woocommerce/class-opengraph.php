...
class Opengraph extends Sitemap {
	...
	public function opengraph() {
		...
		$this->filter( 'cpseo/opengraph/desc', 'og_desc_product_taxonomy' );
		$this->action( 'cpseo/opengraph/facebook', 'og_enhancement', 50 );
		$this->action( 'cpseo/opengraph/facebook/add_additional_images', 'set_opengraph_image' );
	}
