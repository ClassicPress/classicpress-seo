...
class Sitemap {
	...
	public function sitemap() {
		$this->filter( 'cpseo/sitemap/exclude_post_type', 'sitemap_exclude_post_type', 10, 2 );
		$this->filter( 'cpseo/sitemap/post_type_archive_link', 'sitemap_taxonomies', 10, 2 );
		$this->filter( 'cpseo/sitemap/post_type_archive_link', 'sitemap_post_type_archive_link', 10, 2 );
		$this->filter( 'cpseo/sitemap/urlimages', 'add_product_images_to_xml_sitemap', 10, 2 );
	}
